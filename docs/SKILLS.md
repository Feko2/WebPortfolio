...
### Interaction
- No perk tree interaction — in Skyrim you can click individual stars to "unlock" perks. Could add click-to-reveal details on each sub-skill node.
- No keyboard navigation (left/right arrows to switch skills).
