    ...
    <div className="flex-1 overflow-y-auto no-scrollbar px-1 py-1">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[8px] tracking-[0.18em] uppercase text-sky-400/40 font-skyrim">
                    {categoryMeaning}
                  </span>
                </div>
      ...
      {projects.length === 0 && (
        <div className="flex items-center justify-center py-24">
          <p className="font-skyrim text-[11px] tracking-[0.2em] uppercase text-foreground/20">
